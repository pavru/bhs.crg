...
# Нативная служба PostgreSQL на машине разработчика больше не используется: если она запущена,
# порт 5432 занят и контейнер не поднимется. Остановите её и снимите с автозапуска.
