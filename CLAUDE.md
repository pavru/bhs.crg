...
дамп рабочей базы невозможен: репозиторий публичный) и гоняют 53 проверки из 82. Остальные 29
требуют данных, которых посев пока не создаёт, и остаются ручными; проверкам разбиения PDF нужен
ИИ-движок, и они ручными останутся. Подробности и таблица — `src/client/e2e/README.md`.
