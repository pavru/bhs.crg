...
дамп рабочей базы невозможен: репозиторий публичный) и гоняют 39 проверок из 82. Остальные 43
требуют данных, которых посев пока не создаёт, и остаются ручными; проверки разбиения PDF нужен
