...
MinIO, Typst и браузер из сети. Лекарство — «Re-run failed jobs», итог прогона пересчитывается.

Живые прогоны (issue #872) поднимают приложение целиком — postgres, MinIO, Typst CLI,
