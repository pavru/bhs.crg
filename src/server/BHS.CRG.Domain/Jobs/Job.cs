...
public enum JobKind
{
    ...
    SendEmail = 4,
    /// <summary>Сверка «реестр материалов ↔ карта документов качества» по всему комплекту: резолв
    /// каждого документа с чтением наборов данных, на большом комплекте — минуты (issue #628).</summary>
    AuditQualityLinks = 5,
    /// <summary>Снятие резервной копии в каталог на сервере: минуты чтения базы и перекачки
    /// сканов из хранилища, HTTP-запрос столько не живёт (issue #831).</summary>
    CreateBackup = 6,
}
