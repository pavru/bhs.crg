    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_catalog_entities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PluginBindings = table.Column<JsonDocument>(type: "jsonb", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sections_constructions_ConstructionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_document_sets_sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityRefs = table.Column<JsonDocument>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_catalog_entities_EntityType",
                table: "catalog_entities",
                column: "EntityType");

            migrationBuilder.CreateIndex(
                name: "IX_catalog_entities_EntityType_OwnerId",
                table: "catalog_entities",
                columns: new[] { "EntityType", "OwnerId" });

            migrationBuilder.CreateIndex(
                name: "IX_constructions_CreatedByUserId",
                table: "constructions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_document_sets_SectionId",
                table: "document_sets",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sections_ConstructionId",
                table: "sections",
                column: "ConstructionId");

            migrationBuilder.CreateIndex(
                name: "IX_templates_DocumentTypeId_IsActive",
                table: "templates",
