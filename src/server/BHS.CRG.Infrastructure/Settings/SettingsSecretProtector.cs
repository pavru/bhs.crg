...
public class SettingsSecretProtector(IDataProtectionProvider provider)
{
    ...
    public string? Unprotect(string? value)
    {
        ...
        {
            // Ключи Data Protection потеряны или сменились: значение не восстановить. Возвращаем
            // пусто — тогда движок честно скажет «ключ не задан», а не будет ходить в сеть с мусором.
            return null;
        }
    }
}
