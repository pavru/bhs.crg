...
public class UpdateNotifier(AppDbContext db, INotificationService notifier)
{
    ...
    /// пассивный носитель; строить вокруг этого случая отдельный механизм не нужно — почини́тся
    /// состояние прочтения (issue #821), уведомление вернётся к общесистемной форме и деталь
    /// исчезнет сама.
    /// </summary>
