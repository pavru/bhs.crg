...
/// JSON в поисках ссылок и путей к блобам, разбор перечислений, накопитель предупреждений.
/// Проверяются без поднятой базы — ради этого и отделены (issue #1021).</para>
/// </summary>
