...
/// сертификатом — ровно то, что подставится в документ при генерации.
///
...
///
/// В комплекты поддерева не спускаемся: связка действует «отсюда и выше», и набор уровня «Стройка»
/// показывает связки стройки и системы, а не сумму всех своих комплектов.
/// </summary>
