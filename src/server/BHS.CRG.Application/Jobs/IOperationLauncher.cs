...
/// </list>
///
/// Чего эти защиты НЕ дают — атомарности: между проверкой «уже идёт» и постановкой задачи есть
/// окно, и два запроса, пришедшие в одну миллисекунду, поставят две задачи. Окно узкое и было
/// таким всегда; закрывается оно уникальным индексом по (цель, активный статус) — отдельной
/// работой с миграцией, а не здесь.
///
