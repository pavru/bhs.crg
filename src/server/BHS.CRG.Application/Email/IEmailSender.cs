...
/// <summary>Одно письмо: получатели + тема + текст (+ вложения). Тонкий транспортный контракт —
/// оркестрация (резолв получателей, сборка контента/вложений) живёт выше, не в отправителе.</summary>
public record EmailMessage(
    IReadOnlyList<string> To, string Subject, string Body, IReadOnlyList<EmailAttachment>? Attachments = null);
