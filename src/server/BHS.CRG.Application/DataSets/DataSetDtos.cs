...
/// <summary>
/// Предпросмотр материализации. <paramref name="Variants"/> — ключ варианта union'а для каждой
/// показанной строки (issue #716), null-элемент = дискриминатора нет; <paramref name="Skipped"/> —
/// строки, которым варианта не досталось.
///
