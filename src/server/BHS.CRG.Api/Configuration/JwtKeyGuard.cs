...
public static class JwtKeyGuard
{
    ...
    /// <summary>
    /// Значения из файлов-примеров (<c>appsettings.json</c>, <c>deploy/.env.example</c>). Сверяем и
    /// точным совпадением, и по началу строки: пример могли поправить частично, оставив узнаваемое
    /// начало, — такой ключ ничем не лучше исходного.
    /// </summary>
