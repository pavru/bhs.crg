...
public static class DataSetBindingTemplateEndpoints
{
    public static void MapDataSetBindingTemplateEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        g.MapPost("", async (Guid docTypeId, CreateTemplateRequest req, IDataSetService svc, CancellationToken ct) =>
        {
        ...
        g.MapDelete("/{id:guid}", async (Guid docTypeId, Guid id, IDataSetService svc, CancellationToken ct) =>
