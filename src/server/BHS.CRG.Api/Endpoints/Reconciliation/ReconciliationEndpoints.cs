...
public static class ReconciliationEndpoints
{
    public static void MapReconciliationEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        //
        // Сужать правку определения отдельным правом рассматривали и ОТКАЗАЛИСЬ — решение владельца
        // 21.09.2026 (issue #992): сверки ведут те же люди, что их настраивают, и второе право
        // выдавалось бы всегда парой с первым. Цена решения записана в объяснении права: кто может
        // завести определение, тот сравнивает любые наборы и читает их значения в находках.
        //
        // ⚠️ Если решение однажды пересмотрят — новое право заводится ЗДЕСЬ, а не скрытием кнопок:
        // спрятанная кнопка обходится прямым запросом к API.
