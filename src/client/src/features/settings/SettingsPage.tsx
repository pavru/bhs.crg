    ...
    <div className="flex flex-col min-h-0 flex-1">
      ...
      <div className="rounded-lg border border-warning-border bg-warning-subtle p-3 flex gap-2 text-sm text-warning">
        ...
        <span>
          ...
          к состоянию на момент копии система не вернётся.
        </span>
      </div>
      </div>
        ...
        <div className="rounded-lg border border-stroke overflow-hidden">
          ...
          */}
          <p className="px-4 py-2 text-xs text-fg3 border-t border-stroke">
            ...
            созданное после снятия копии останется на месте.
          </p>
        </div>
      )}
        ...
        <div className="flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-xs text-fg3 mt-0.5">
              ...
              Ничего <b>не удаляется</b>: созданное после снятия копии останется на месте.
            </p>
          </div>
          <button
            type="button"
