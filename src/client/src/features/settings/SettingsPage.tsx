    ...
    <div className="flex flex-col min-h-0 flex-1">
      ...
      <div className="rounded-lg border border-warning-border bg-warning-subtle p-3 flex gap-2 text-sm text-warning">
        ...
        <span>
          ...
          {' '}
          Восстановление <b>ничего не удаляет</b>: записи, созданные после снятия копии, останутся —
          к состоянию на момент копии система не вернётся. <b>Исключение — библиотека Typst:</b> её
          дерево файлов замещается целиком, и файлов, которых нет в копии, не останется.
        </span>
      </div>
      </div>
      ...
      <CollapsibleSection title="Резервное копирование" storageKey="backup" defaultOpen={false}>
        ...
        <div className="flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-xs text-fg3 mt-0.5">Скачать архив .zip с текущей конфигурацией системы</p>
          </div>
          <button
            type="button"
        ...
        <div className="flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-xs text-fg3 mt-0.5">
              Загрузить файл .zip. Существующие записи будут обновлены, новые — добавлены.
              Ничего <b>не удаляется</b>, кроме дерева файлов библиотеки Typst — оно замещается целиком.
            </p>
          </div>
          <button
            type="button"
