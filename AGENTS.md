...
дамп рабочей базы невозможен: репозиторий публичный) и гоняют все восемь прогонов, 86 проверок из
89. Ручными остались три — разбиение PDF: им нужны распознанные страницы, то есть ИИ-движок,
