...
дамп рабочей базы невозможен: репозиторий публичный) и гоняют все восемь прогонов, 91 проверку из
94. Ручными остались три — разбиение PDF: им нужны распознанные страницы, то есть ИИ-движок,
